...
namespace ED_Explorer {
   public class JournalSystemWatcher : FileSystemWatcher, IDisposable {
      ...
      public JournalSystemWatcher()
      {
         InitializeMembers();
      }

      public JournalSystemWatcher(string path) : base(path) {
         InitializeMembers();
      }

      public JournalSystemWatcher(string path, string filter) : base(path, filter) {
         InitializeMembers();
      }
      #endregion
